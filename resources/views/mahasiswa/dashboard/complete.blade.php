...
@section('content')
                            ...
                            <div class="material-card-body">
                                ...
                                <div class="progress-section">
                                    <div class="progress-info d-flex justify-content-between">
                                        ...
                                        @php
                                            $overallPct = ($stats['overall']['total'] > 0) ? min(100, round(($stats['overall']['correct'] / $stats['overall']['total']) * 100)) : 0;
                                        @endphp
                                        <span class="progress-percentage">{{ $overallPct }}%</span>
                                    </div>
                                    <div class="progress-bar-container">
                                        <div class="progress-bar" style="width: {{ $overallPct }}%"></div>
                                    </div>
                                    <div class="progress-details">
                                        <small>{{ $stats['overall']['correct'] }} dari {{ $stats['overall']['total'] }} soal
                                            selesai</small>
                                    </div>
                                </div>
                                ...
                                <div class="difficulty-progress-container">
                                    ...
                                    <div class="difficulty-progress beginner">
                                        ...
                                        <div class="difficulty-bar-container">
                                            <div class="difficulty-bar" style="width: {{ $stats['beginner']['percentage'] }}%">
                                            </div>
                                        </div>
                                        <div class="difficulty-percentage">{{ $stats['beginner']['percentage'] }}%</div>
                                        <div class="difficulty-details">
                                            <small>{{ $stats['beginner']['correct'] }}/{{ $stats['beginner']['configured_total'] }}
                                                soal</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="difficulty-progress medium">
                                        ...
                                        <div class="difficulty-details">
                                            <small>{{ $stats['medium']['correct'] }}/{{ $stats['medium']['configured_total'] }}
                                                soal</small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="difficulty-progress hard">
                                        ...
                                        <div class="difficulty-details">
                                            <small>{{ $stats['hard']['correct'] }}/{{ $stats['hard']['configured_total'] }}
                                                soal</small>
                                        </div>
                                    </div>
                                </div>
    ...
    @push('css')
        <style>
            ...
            .difficulty-progress {
                display: grid;
                grid-template-columns: minmax(110px, 110px) 1fr auto;
            ...
            .btn-view-green:hover {
                ...
                background: linear-gradient(135deg, #218838 0%, #48a04c 100%);
                color: white;
            }
