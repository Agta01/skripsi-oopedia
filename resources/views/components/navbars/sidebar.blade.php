...
<aside id="sidenav-main" class="oopsidebar">
    ...
    <nav class="oopsidebar__nav">
        ...
        @if(auth()->user()->role_id <= 2)
            ...
            <a href="{{ route('admin.ueq.index') }}" class="oopsidebar__item {{ $activePage == 'ueq' ? 'is-active' : '' }}">
            ...
            <a href="{{ route('admin.tbut.index') }}"
                ...
                <span>Analisa Virtual Code</span>
                <span class="hover-highlight"></span>
            </a>
        @endif
...
<style>
    ...
    .oopsidebar__item:nth-child(2) {
        animation-delay: 0.05s;
    }

    .oopsidebar__item:nth-child(3) {
        animation-delay: 0.1s;
    }

    .oopsidebar__item:nth-child(4) {
        animation-delay: 0.15s;
    }

    .oopsidebar__item:nth-child(5) {
        animation-delay: 0.2s;
    }

    .oopsidebar__item:nth-child(6) {
        animation-delay: 0.25s;
    }

    .oopsidebar__item:nth-child(7) {
