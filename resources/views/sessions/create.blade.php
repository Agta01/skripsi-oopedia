                                ...
                                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                                    <div class="bg-gradient-primary shadow-primary border-radius-lg py-3 pe-1">
                                        <div class="text-center">
                                            <img src="{{ asset('images/logo.png') }}" alt="Logo OOPedia" style="width: 120px; height: auto; margin-bottom: 10px;">
                                        </div>
                                        <h4 class="text-white font-weight-bolder text-center mt-0 mb-0">Login to OOPedia</h4>
                                        <div class="row mt-3">
