        ...
        <div class="row g-0 vh-100 bg-white">
            ...
            <div class="col-lg-5 d-none d-lg-flex flex-column justify-content-center align-items-center position-relative overflow-hidden"
                ...
                <div class="position-absolute w-100 h-100"
                    style="background-image: radial-gradient(circle at 2px 2px, rgba(255,255,255,0.15) 1px, transparent 0); background-size: 24px 24px; opacity: 0.6;">
                </div>
                <div class="position-absolute rounded-circle"
                    style="width: 300px; height: 300px; background: rgba(255,255,255,0.05); top: -50px; left: -100px; filter: blur(2px);">
                </div>
                <div class="position-absolute rounded-circle"
                    style="width: 200px; height: 200px; background: rgba(255,255,255,0.08); bottom: -30px; right: -50px; filter: blur(1px);">
                </div>

                <!-- Content -->
                <div class="position-relative z-index-2 text-center px-4">
                    <img src="{{ asset('images/logo.png') }}" alt="Logo OOPedia" class="mb-4 img-fluid drop-shadow-lg"
                        style="max-height: 140px;">
                    <h2 class="text-white font-weight-bolder mb-3" style="letter-spacing: -0.5px;">Selamat Datang
                        Kembali!</h2>
                    <p class="text-white opacity-8 fs-6 px-lg-4" style="line-height: 1.6;">
                        Lanjutkan progres pembelajaran Pemrograman Berorientasi Objek Anda dan raih pemahaman mendalam
            ...
            <div
                class="col-lg-7 col-12 d-flex align-items-center justify-content-center position-relative bg-white pt-5 pt-lg-0">
                <div class="w-100 px-4 px-md-5 px-lg-6" style="max-width: 550px;">
                    ...
                    <form role="form" method="POST" action="{{ route('login') }}" class="modern-form">
                        ...
                        @if (Session::has('status'))
                            <div class="alert alert-success alert-dismissible text-white border-0 shadow-sm rounded-3 mb-4"
                                role="alert" style="background: #10b981;">
                                <span class="text-sm fw-medium"><i
                                        class="fas fa-check-circle me-2"></i>{{ Session::get('status') }}</span>
                        ...
                        @if ($errors->any() || Session::has('error'))
                            <div class="alert alert-danger alert-dismissible text-white border-0 shadow-sm rounded-3 mb-4"
                                role="alert" style="background: #ef4444;">
                                ...
                                <button type="button" class="btn-close text-white opacity-50" data-bs-dismiss="alert"
                                    aria-label="Close"></button>
                            </div>
                        @endif
                        ...
                        <div class="mb-4">
                            ...
                            <div class="custom-input-group mt-1 @error('email') border-danger @enderror">
                                ...
                                <input type="email" id="email" class="form-control" name="email"
                                    placeholder="contoh@kampus.ac.id" required autofocus>
                            </div>
                            @error('email')
                                <p class='text-danger text-xs mt-2 fw-medium mb-0'><i
                                        class="fas fa-exclamation-circle me-1"></i>{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div
                                class="custom-input-group mt-1 @error('password') border-danger @enderror position-relative">
                                <span class="input-icon"><i class="fas fa-lock"></i></span>
                                <input type="password" id="password" class="form-control pe-5" name="password"
                                    placeholder="Masukkan kata sandi Anda" required>
                                <button type="button"
                                    class="btn btn-link position-absolute end-0 top-50 translate-middle-y text-decoration-none p-0 me-3 shadow-none border-0"
                            ...
                            <div class="col-12 text-center mt-3">
                                <p class="text-sm text-secondary mb-2">
                                    ...
                                    <a href="{{ route('register') }}"
                                        class="text-primary fw-bold text-decoration-none">Daftar di sini</a>
                                </p>
                                <p class="text-sm text-secondary mb-0">
                                    Ingin mencoba materi gratis?
                                    <a href="{{ route('mahasiswa.materials.index') }}"
                                        class="text-info fw-bold text-decoration-none">Mode Tamu</a>
                                </p>
                            </div>
                        </div>
                    </form>
