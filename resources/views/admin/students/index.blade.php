            ...
            <div class="row">
                <div class="col-12">
                    <div class="card my-4 modern-card">
                        ...
                        <div
                            class="card-header modern-header px-4 pt-4 pb-3 d-flex justify-content-between align-items-center">
                            <h6 class="text-capitalize modern-header-title mb-0">Data Mahasiswa</h6>
                            <div class="d-flex me-0">
                                <a href="{{ route('admin.students.import') }}" class="btn btn-sm btn-primary mb-0">
                                ...
                                <table class="table align-items-center mb-0">
                                    <thead class="modern-table-header">
                                        <tr>
                                            ...
                                            <th class="text-center">Total Soal Dijawab</th>
                                            <th class="text-center">Progress Keseluruhan</th>
                                            <th class="text-center">Aksi</th>
                                        </tr>
                                    </thead>
                                    <tbody class="modern-table-row">
