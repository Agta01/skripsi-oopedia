                    ...
                    <div class="card my-4">
                        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                            <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                                <h6 class="text-white text-capitalize ps-3">Form Tugas Baru</h6>
                            </div>
                        </div>
                        <div class="card-body px-0 pb-2">
                            <form action="{{ route('admin.virtual-lab-tasks.store') }}" method="POST" class="px-4 py-3">
                                @csrf
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="description" class="form-control tinymce" rows="10"></textarea>
                                </div>
                                ...
                                <div class="mb-4">
                                    ...
                                    <textarea name="template_code" class="form-control font-monospace" rows="10" style="background: #f5f5f5; font-family: 'Courier New', Courier, monospace;">public class Main {
