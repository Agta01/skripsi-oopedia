                                    ...
                                    <tbody>
                                        @forelse($tasks as $task)
                                            <tr>
                                                ...
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0">{{ $task->material->title }}
                                                    </p>
                                                </td>
                                                <td>
                                                    <span
                                                        class="badge badge-sm bg-gradient-{{ $task->difficulty == 'beginner' ? 'success' : ($task->difficulty == 'intermediate' ? 'warning' : 'danger') }}">
