        ...
        <div class="container-fluid py-4">
            ...
            <div class="row g-3 mb-4">
                ...
                <div class="col-xl-3 col-sm-6 animate-fade-in" style="animation-delay: 0s">
                    <div class="card border-0 h-100 kpi-card"
                        style="background:linear-gradient(135deg,#667eea,#764ba2);background-size:200% 200%;animation:gradient-shift 5s ease infinite;border-radius:16px!important">
                        <div class="card-body p-4 d-flex align-items-center justify-content-between">
                            <div>
                                <p class="text-white text-sm opacity-8 mb-1 fw-semibold text-uppercase ls-1">Total
                                    Mahasiswa</p>
                                <h2 class="text-white fw-bolder mb-0">{{ $totalStudents }}</h2>
                                <small class="text-white opacity-7">terdaftar</small>
                            </div>
                            <div class="d-flex align-items-center justify-content-center rounded-circle icon-wrapper"
                ...
                <div class="col-xl-3 col-sm-6 animate-fade-in" style="animation-delay: 0.1s">
                    <div class="card border-0 h-100 kpi-card"
                        style="background:linear-gradient(135deg,#11998e,#38ef7d);background-size:200% 200%;animation:gradient-shift 5s ease infinite;border-radius:16px!important">
                        <div class="card-body p-4 d-flex align-items-center justify-content-between">
                            <div>
                                <p class="text-white text-sm opacity-8 mb-1 fw-semibold text-uppercase ls-1">Mahasiswa
                                    Aktif</p>
                ...
                <div class="col-xl-3 col-sm-6 animate-fade-in" style="animation-delay: 0.2s">
                    <div class="card border-0 h-100 kpi-card"
                        style="background:linear-gradient(135deg,#f093fb,#f5576c);background-size:200% 200%;animation:gradient-shift 5s ease infinite;border-radius:16px!important">
                        <div class="card-body p-4 d-flex align-items-center justify-content-between">
                            <div>
                                <p class="text-white text-sm opacity-8 mb-1 fw-semibold text-uppercase ls-1">Total
                                    Materi</p>
                ...
                <div class="col-xl-3 col-sm-6 animate-fade-in" style="animation-delay: 0.3s">
                    <div class="card border-0 h-100 kpi-card"
                        style="background:linear-gradient(135deg,#4facfe,#00f2fe);background-size:200% 200%;animation:gradient-shift 5s ease infinite;border-radius:16px!important">
                        <div class="card-body p-4 d-flex align-items-center justify-content-between">
                            <div>
                                <p class="text-white text-sm opacity-8 mb-1 fw-semibold text-uppercase ls-1">Total Soal
                                </p>
                        ...
                        <div class="card-header bg-white border-0 pt-4 pb-0 px-4">
                            <div class="d-flex align-items-center justify-content-between">
                                ...
                                <span class="badge bg-gradient-primary"
                                    style="animation: pulse-glow 2s ease-in-out infinite">Chart</span>
                            </div>
                        </div>
                            ...
                            <div class="w-100">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <div class="d-flex align-items-center gap-2">
                                        <span
                                            style="width:10px;height:10px;border-radius:50%;background:#28a745;display:inline-block"></span>
                                ...
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <div class="d-flex align-items-center gap-2">
                                        <span
                                            style="width:10px;height:10px;border-radius:50%;background:#e9ecef;display:inline-block"></span>
                                ...
                                <div class="d-flex justify-content-between text-sm">
                                    ...
                                    <span
                                        class="fw-bold">{{ $tbutAvgDur ? gmdate('i:s', intval($tbutAvgDur)) : '-' }}</span>
                                </div>
                                ...
                                <div class="mt-3 text-center">
                                    <a href="{{ route('admin.tbut.index') }}"
                                        class="btn btn-sm btn-outline-primary w-100 btn-modern">
                                        <i class="material-icons text-sm me-1"
                                            style="vertical-align:middle">open_in_new</i> Detail Analisis
                                    </a>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center gap-3 py-1">
                                                        <div class="d-flex align-items-center justify-content-center text-white fw-bold rounded-circle student-avatar"
                                                            style="width:36px;height:36px;font-size:14px;background:linear-gradient(135deg,#667eea,#764ba2);flex-shrink:0">
                                                            {{ strtoupper(substr($student->name, 0, 1)) }}
                                                        </div>
                                                        <div>
                                                            <h6 class="mb-0 text-sm fw-semibold student-name">
                                                                {{ $student->name }}</h6>
                                                ...
                                                <td class="align-middle text-center">
                                                    <span
                                                        class="badge bg-gradient-primary">{{ $student->completed_questions }}</span>
                                                </td>
                                                    ...
                                                    <div class="d-flex align-items-center gap-2">
                                                        <div class="progress flex-grow-1"
                                                            ...
                                                            <div class="progress-bar bg-gradient-primary"
                                                                style="width:{{ min(100, $student->materials_progress) }}%">
                                                            </div>
                                                        </div>
                                                        <small
                                                            class="text-secondary fw-semibold text-xs">{{ $student->materials_progress }}%</small>
                                                    </div>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
                                                <td colspan="3" class="text-center text-secondary py-4">
                                                    <i class="material-icons d-block mb-1">hourglass_empty</i> Belum ada
                                                    data
                                                </td>
                                            </tr>
                                        @endforelse
                            ...
                            @forelse($popularMaterials as $i => $mat)
                                ...
                                <div class="d-flex align-items-center justify-content-between mb-3 material-item">
                                    <div class="d-flex align-items-center gap-3">
                                        <div class="d-flex align-items-center justify-content-center text-white fw-bold rounded-2 material-rank"
                                            style="width:38px;height:38px;background:{{ $color }};flex-shrink:0;font-size:15px">
                                            {{ $i + 1 }}
                                        </div>
                                        <div>
                                            <p class="mb-0 text-sm fw-semibold text-truncate material-title"
                                                style="max-width:160px">{{ $mat->title }}</p>
                                            <p class="mb-0 text-xs text-secondary">{{ $mat->students_count }} mahasiswa</p>
                                        </div>
                                    </div>
                                    <div class="text-end">
                                        <p class="mb-0 text-sm fw-bold" style="color:{{ $color }}">
                                            {{ $mat->completion_rate ?? 0 }}%</p>
                                            ...
                                            <tr class="activity-row">
                                                <td>
                                                    <div class="d-flex px-2 py-1 align-items-center">
                                                        <div class="d-flex align-items-center justify-content-center text-white fw-bold rounded-circle me-3 activity-avatar"
                                                            style="width:32px;height:32px;font-size:12px;background:linear-gradient(135deg,#4facfe,#00f2fe);flex-shrink:0">
                                                ...
                                                <td>
                                                    <p class="text-xs font-weight-bold mb-0">
                                                        {{ $prog->material->title ?? '-' }}</p>
                                                    <p class="text-xs text-secondary mb-0">Soal #{{ $prog->question_id }}
                                                    </p>
                                                </td>
                                                <td class="align-middle text-center text-sm">
                                                    @if($prog->is_correct)
                                                        <span class="badge badge-sm bg-gradient-success"><i
                                                                class="fas fa-check me-1"></i>Benar</span>
                                                    @else
                                                        <span class="badge badge-sm bg-gradient-danger"><i
                                                                class="fas fa-times me-1"></i>Salah</span>
                                                    @endif
                                                </td>
                                                <td class="align-middle text-center">
                                                    <span
                                                        class="text-secondary text-xs">{{ $prog->created_at->diffForHumans() }}</span>
                                                </td>
                                            </tr>
                                        @empty
                                            <tr>
