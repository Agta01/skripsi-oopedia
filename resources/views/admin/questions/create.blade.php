<x-layout bodyClass="g-sidenav-show bg-gray-200">
    ...
    <x-navbars.sidebar activePage="questions" :userName="auth()->user()->name"
    ...
    <main class="main-content position-relative border-radius-lg">
        ...
        <div class="container-fluid py-4 px-4">
            ...
            <div class="qs-page-header">
                ...
                <div>
                    ...
                    <div class="qs-page-sub">
                        @if(isset($material))
                            <a href="{{ route('admin.materials.questions.index', $material) }}" class="qs-link">Soal
                                Materi</a>
            ...
            @if (isset($material))
                <form method="POST" action="{{ route('admin.materials.questions.store', $material) }}" class="qs-form"
                    id="questionForm">
            @else
                ...
                @endif
                    ...
                    <div class="qs-grid">
                        ...
                        <div class="qs-col-main">
                            ...
                            <div class="qs-card">
                                <div class="qs-card-hdr">
                                    <div class="qs-card-icon" style="background:#eff6ff;color:#0057B8;"><i
                                ...
                                <div class="qs-card-body">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="question_type" class="qs-input" required
                                        ...
                                        <div class="col-md-6">
                                            <label class="qs-label">Tingkat Kesulitan <span
                            ...
                            <div class="qs-card">
                                <div class="qs-card-hdr">
                                    <div class="qs-card-icon" style="background:#f0fdf4;color:#059669;"><i
                            ...
                            <div class="qs-card">
                                <div class="qs-card-hdr"
                                    ...
                                    <div class="qs-card-icon" style="background:rgba(255,255,255,.2);color:#fff;"><i
                                ...
                                <div class="qs-card-body">
                                    ...
                                    <div id="answers-container">
                                        ...
                                        <div class="qs-answer-entry" data-index="0">
                                            ...
                                            <input type="text" name="answers[0][answer_text]"
                                                class="qs-input qs-answer-input" placeholder="Tulis opsi jawaban…"
                                                required>
                                    ...
                                    <button type="button" class="qs-btn-add-answer" id="add-answer-btn"
                                        onclick="addAnswer()">
                        ...
                        {{-- ═══ SIDE COLUMN ═══ --}}
                        <div class="qs-col-side qs-col-side--sticky">

                            {{-- Type description --}}
                            <div class="qs-card" id="typeInfoCard">
                                <div class="qs-card-hdr">
                                    <div class="qs-card-icon" style="background:#f5f3ff;color:#7c3aed;"><i
                                ...
                                <div class="qs-card-body" id="typeInfoBody">
                                    <div class="qs-type-info" id="info-fill_in_the_blank">
                                        <div class="qs-type-badge" style="background:#eff6ff;color:#0057B8;">✏️ Fill in
                                            the Blank</div>
                                        <p class="qs-type-desc">Mahasiswa mengisi jawaban sendiri. Hanya satu kolom
                                            jawaban yang disediakan sistem.</p>
                                    </div>
                                    <div class="qs-type-info" id="info-radio_button" style="display:none;">
                                        <div class="qs-type-badge" style="background:#f5f3ff;color:#7c3aed;">🔘 Radio
                                            Button</div>
                                        <p class="qs-type-desc">Pilihan ganda klasik. Tambahkan minimal <strong>3 opsi</strong> dan
                                            tandai satu sebagai jawaban benar.</p>
                                    </div>
                                    <div class="qs-type-info" id="info-drag_and_drop" style="display:none;">
                                        <div class="qs-type-badge" style="background:#fef3c7;color:#d97706;">🔀 Drag and
                                            Drop</div>
                                        <p class="qs-type-desc">Mahasiswa menyusun opsi jawaban dengan menyeret. Urutan
                                            jawaban pertama dianggap benar.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="qs-card" style="border-color:#fef3c7;">
                                <div class="qs-card-hdr" style="background:#fffbf5;border-bottom-color:#fef3c7;">
                                    <div class="qs-card-icon" style="background:#fef3c7;color:#d97706;"><i
                                            class="fas fa-lightbulb"></i></div>
                                    <h6 class="qs-card-title">Tips Membuat Soal</h6>
                                </div>
                                <div class="qs-card-body" style="padding-top:12px;">
                                    <ul class="qs-tips">
                                        <li>Gunakan bahasa yang jelas dan tidak ambigu</li>
                                        <li>Untuk radio button, <strong>minimal 3</strong> opsi jawaban</li>
        ...
        <div class="qs-floating-save">
            @if(isset($material))
                <a href="{{ route('admin.materials.questions.index', $material) }}" class="qs-floating-save__cancel">
                    <i class="fas fa-times"></i> Batal
                </a>
            @else
                <a href="{{ route('admin.questions.index') }}" class="qs-floating-save__cancel">
                    <i class="fas fa-times"></i> Batal
                </a>
            @endif
            <button type="button" id="submitBtn" class="qs-floating-save__btn" onclick="document.getElementById('questionForm').dispatchEvent(new Event('submit', {cancelable:true,bubbles:true}))">
    ...
    @push('js')
        ...
        <script>
            ...
            document.addEventListener('DOMContentLoaded', () => {
                ...
                // Form validation
                // Add SweetAlert validation
                document.getElementById('questionForm').addEventListener('submit', function (e) {
                    e.preventDefault();
                    // Sync Quill content first
                    const quill = window._quillInstance;
                    const questionTextarea = document.getElementById('content-editor');
                    if (quill) {
                    ...
                    if (type === 'radio_button') {
                        const answerCount = document.querySelectorAll('.qs-answer-entry').length;
                        if (answerCount < 3) {
                            Swal.fire({
                                icon: 'warning',
                                title: 'Validasi Opsi',
                                text: 'Soal pilihan ganda (Radio Button) harus memiliki minimal 3 opsi jawaban!',
                                confirmButtonColor: '#4f46e5'
                            });
                            return;
                        }
                        ...
                        if (!selected) { 
                            Swal.fire({
                                icon: 'warning',
                                title: 'Pilih Jawaban',
                                text: 'Harap pilih satu opsi sebagai jawaban yang benar!',
                                confirmButtonColor: '#4f46e5'
                            });
                            return; 
                        }
                    ...
                    // Show loading on submit button before actual submit
...
<style>
    ...
    .qs-floating-save__btn:hover {
        transform: translateY(-2px);
        box-shadow: 0 8px 25px rgba(99, 102, 241, 0.45);
        color: #fff;
    }
    
    .qs-floating-save__btn:active {
        transform: translateY(1px);
    }

    .qs-floating-save__cancel {
        display: inline-flex;
        align-items: center;
        gap: 8px;
        padding: 12px 20px;
    ...
    .qs-floating-save__cancel:hover {
